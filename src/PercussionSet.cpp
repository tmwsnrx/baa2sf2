...
to_float_pan(uint8_t pan);

namespace z2sound
{

void
PercussionSet::set_entry(Key key, PercussionSet::PercussionEntry entry)
{
    key_map_.insert_or_assign(key, entry);
}

Instrument::Type
PercussionSet::get_type() const
{
    return Instrument::Type::Percussion;
}

std::vector<Instrument::KeyZone>
PercussionSet::get_key_zones() const
{
